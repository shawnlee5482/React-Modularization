	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        Route,
	        { path: '/ninjas' },
	        React.createElement(IndexRoute, { component: NinjaComponent, data: this.props.data }),
	        React.createElement(Route, { path: ':id', component: NinjaDescription, fetchTurtle: this.fetchTurtle })
	      )
	    );
	  }
	});
